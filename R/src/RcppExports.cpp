...
RcppExport SEXP _oiff_find_optimal_filter(SEXP pvaluesSEXP, SEXP covariatesSEXP, SEXP thresholdSEXP, SEXP largerSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(find_optimal_filter(pvalues, covariates, threshold, larger));
...
RcppExport SEXP _oiff_find_optimal_filter_subsample(SEXP pvaluesSEXP, SEXP covariatesSEXP, SEXP thresholdSEXP, SEXP largerSEXP, SEXP subsample_proportionSEXP, SEXP num_iterationsSEXP, SEXP random_seedSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type pvalues(pvaluesSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type covariates(covariatesSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(find_optimal_filter_subsample(pvalues, covariates, threshold, larger, subsample_proportion, num_iterations, random_seed, num_threads));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_oiff_find_optimal_filter", (DL_FUNC) &_oiff_find_optimal_filter, 4},
    {"_oiff_find_optimal_filter_subsample", (DL_FUNC) &_oiff_find_optimal_filter_subsample, 8},
    {NULL, NULL, 0}
};
